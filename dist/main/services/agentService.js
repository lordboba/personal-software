export function proposePersonalization(app, request) {
    return {
        ...
        summary: "The agent will inspect the current repo state, create a copy-on-write branch, apply scoped config/branding/feature edits, then ask before commit and push.",
        steps: [
