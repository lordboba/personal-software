export function proposePersonalization(app, request) {
    return {
        title: `Personalize ${app.title}`,
        summary: "The agent will inspect the current repo state, create a copy-on-write branch, record the personalization contract in .personal-software/PATCH.md, apply scoped config/branding/feature edits, then ask before commit and push.",
        steps: [
