import type { GitHubAccount, ManagedApp } from "../../shared/types.js";
...
export class GitHubService {
  ...
  async createFork(app: ManagedApp) {
    if (!this.token) {
    ...
    const body = (await response.json()) as { clone_url: string; html_url: string };
    return {
